...
Dependency: aiokafka
Not installed by default; install extra: `pip install taf[kafka]`.
"""
    ...
    def __init__(self, config: dict[str, Any] | None = None):
        ...
        Args:
            config: Configuration dictionary. Supported keys:
                ...
                - topic: Kafka topic to publish to (default: "taf.events").
                - client_id: Client ID for the producer.
        """
        super().__init__(config or {})
        self.bootstrap_servers: str = self.config.get("bootstrap_servers", "localhost:9092")
        self.topic: str = self.config.get("topic", "taf.events")
    ...
    async def _get_producer(self):
        ...
        try:
            ...
            raise RuntimeError(
                ...
                "'pip install taf[kafka]' or 'pip install aiokafka'."
            ) from exc
