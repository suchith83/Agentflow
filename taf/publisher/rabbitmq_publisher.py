...
Dependency: aio-pika
Not installed by default; install extra: `pip install taf[rabbitmq]`.
"""
    ...
    def __init__(self, config: dict[str, Any] | None = None):
        ...
        Args:
            config: Configuration dictionary. Supported keys:
                ...
                - exchange: Exchange name (default: "taf.events").
                - routing_key: Routing key (default: "taf.events").
        ...
        self.exchange: str = self.config.get("exchange", "taf.events")
        self.routing_key: str = self.config.get("routing_key", "taf.events")
    ...
    async def _ensure(self):
        ...
        try:
            ...
            raise RuntimeError(
                ...
                "'pip install taf[rabbitmq]' or 'pip install aio-pika'."
            ) from exc
