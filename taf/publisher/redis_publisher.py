...
Not installed by default; install extra: `pip install taf[redis]`.
"""
    ...
    def __init__(self, config: dict[str, Any] | None = None):
        ...
        Args:
            config: Configuration dictionary. Supported keys:
                ...
                - channel: Pub/Sub channel name (default: "taf.events").
                - stream: Stream name (default: "taf.events").
                - maxlen: Max length for streams.
        ...
        self.channel: str = self.config.get("channel", "taf.events")
        self.stream: str = self.config.get("stream", "taf.events")
    ...
    async def _get_client(self):
        ...
        try:
            ...
            raise RuntimeError(
                ...
                "'pip install taf[redis]' or 'pip install redis'."
            ) from exc
