...
def configure_logging(
    ...
    This function sets up logging for all modules under the 'taf' namespace.
    ...
    Example:
        >>> configure_logging(level=logging.DEBUG)
        >>> logger = logging.getLogger("taf.module")
    ...
    # Configure root logger for taf
    root_logger = logging.getLogger("taf")
