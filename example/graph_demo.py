...
#     )
#     critique_agent = Agent(name="critic", model="gemini-2.0-flash", custom_llm_provider="gemini")

#     g = Graph()
#     g.add_node(
#         LLMNode(name="summarize", agent=summarize_agent, prompt_builder=summarize_builder),
#         start=True,
#     )
#     g.add_node(
#         LLMNode(
