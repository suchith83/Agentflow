...
from pyagenity.adapters.tools.langchain_adapter import LangChainAdapter, LangChainToolWrapper
...
class TestLangChainAdapter:
    ...
    @patch('pyagenity.adapters.tools.langchain_adapter.HAS_LANGCHAIN', False)
    ...
    @patch('pyagenity.adapters.tools.langchain_adapter.HAS_LANGCHAIN', True)
